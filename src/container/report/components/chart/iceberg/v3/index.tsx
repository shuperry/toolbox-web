...
const valNameLineConf = [
  {
    ...
    lineImg: '/images/iceberg/type-3/env-val-line.png',
    lineStyle: {
      left: '24px',
      top: '686px',
      height: '126px',
  ...
  },
  {
    ...
    lineImg: '/images/iceberg/type-3/val-line-1.png',
    lineStyle: {
      left: '269px',
      top: '68px',
      width: '194px',
  ...
  },
  {
    ...
    lineImg: '/images/iceberg/type-3/val-line-2.png',
    lineStyle: {
      left: '269px',
      top: '249px',
      width: '194px',
  ...
  },
  {
    ...
    lineImg: '/images/iceberg/type-3/val-line-3.png',
    lineStyle: {
      left: '272px',
      top: '461px',
      width: '191px',
